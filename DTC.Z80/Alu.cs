...
public sealed class Alu
{
    ...
    private readonly Registers m_theRegisters;

    internal Alu(Registers theRegisters)
    {
        m_theRegisters = theRegisters;
    }

    internal byte SubtractAndSetFlags(byte a, byte b, bool subCf)
    {
        int v = a;
        v -= b;

        var needCarry = subCf && m_theRegisters.Cf;
        if (needCarry)
            v--;

        var result = (byte) (v & 0xff);

        m_theRegisters.Hf = IsHalfCarry8(a, b, needCarry, false);
        m_theRegisters.Cf = IsCarry8(v);
        m_theRegisters.Sf = !IsBytePositive(result);
        m_theRegisters.Zf = v == 0;
        m_theRegisters.Pf = IsOverflow8(a, b, result, false);
        m_theRegisters.Nf = true;
        m_theRegisters.SetFlags53From((byte)v);
        return (byte)v;
    }

    internal ushort SubtractAndSetFlags(int a, int b, bool subCf)
    {
        var v = a - b;
        var needCarry = subCf && m_theRegisters.Cf;
        if (needCarry)
        ...
        m_theRegisters.Hf = IsHalfCarry16((ushort) a, (ushort) b, needCarry, false);
        m_theRegisters.Cf = IsCarry16(v);
        m_theRegisters.Sf = !IsWordPositive(result);
        m_theRegisters.Zf = v == 0;
        m_theRegisters.Pf = IsOverflow16((ushort)a, (ushort)b, result, false);
        m_theRegisters.Nf = true;
        m_theRegisters.SetFlags53From(result);
        return result;
    }

    internal byte AddAndSetFlags(byte a, byte b, bool addCf)
    {
        int v = a;
        v += b;

        var needCarry = addCf && m_theRegisters.Cf;
        if (needCarry)
            v++;
        ...
        m_theRegisters.Sf = !IsBytePositive(result);
        m_theRegisters.Zf = result == 0;
        m_theRegisters.Pf = IsOverflow8(a, b, result, true);
        m_theRegisters.Hf = IsHalfCarry8(a, b, needCarry, true);
        m_theRegisters.Cf = IsCarry8(v);
        m_theRegisters.Nf = false;
        m_theRegisters.SetFlags53From(result);

        return result;
    }

    internal ushort AddAndSetFlags(ushort a, ushort b, bool addCf)
    {
        var v = a + b;
        var needCarry = addCf && m_theRegisters.Cf;
        if (needCarry)
        ...
        if (addCf)
        {
            m_theRegisters.Sf = !IsWordPositive((ushort)v);
            m_theRegisters.Zf = result == 0;
            m_theRegisters.Pf = IsOverflow16(a, b, result, true);
        }

        m_theRegisters.Hf = IsHalfCarry16(a, b, needCarry, true);
        m_theRegisters.Cf = IsCarry16(v);
        m_theRegisters.Nf = false;
        m_theRegisters.SetFlags53From(result);
    ...
    private static bool IsBytePositive(byte b) =>
        (b & 0x80) == 0;
    ...
    public byte DecAndSetFlags(byte b)
    {
        ...
        m_theRegisters.Hf = IsHalfCarry8(b, 0x01, false, false);
        m_theRegisters.Sf = !IsBytePositive(result1);
        m_theRegisters.Zf = (byte)v == 0;
        m_theRegisters.Nf = true;
        var result = (byte)v;
        m_theRegisters.Pf = b == 0x80;
        m_theRegisters.SetFlags53From(result);
        return result;
    }
    ...
    public byte IncAndSetFlags(byte b)
    {
        int v = b;
        v += 0x01;
        m_theRegisters.Hf = IsHalfCarry8(b, 0x01, false, true);
        m_theRegisters.Sf = !IsBytePositive((byte)v);
        m_theRegisters.Zf = (byte)v == 0;
        m_theRegisters.Nf = false;
        m_theRegisters.Pf = b == 0x7F;
        m_theRegisters.SetFlags53From((byte)v);
    ...
    {
        var r = (byte) (m_theRegisters.Main.A & b);
        m_theRegisters.Sf = !IsBytePositive(r);
        m_theRegisters.Zf = r == 0;
        m_theRegisters.Hf = true;
        m_theRegisters.Pf = IsEvenParity(r);
        m_theRegisters.Nf = false;
        m_theRegisters.Cf = false;
        m_theRegisters.SetFlags53From(r);

        m_theRegisters.Main.A = r;
    }
    ...
    {
        int lookupIndex = m_theRegisters.Main.A;
        if (m_theRegisters.Cf) lookupIndex |= 256;
        if (m_theRegisters.Hf) lookupIndex |= 512;
        if (m_theRegisters.Nf) lookupIndex |= 1024;
        m_theRegisters.Main.AF = m_daaTable[lookupIndex];
    }

    /// <summary>
    /// Rotate register left through carry status.
    /// </summary>
    /// <remarks>
    ...
    internal byte RotateLeft(byte b)
    {
        ...
        var oldCarry = (byte)(m_theRegisters.Cf ? 1 : 0);
        b <<= 1;
        b |= oldCarry;
        m_theRegisters.Sf = !IsBytePositive(b);
        m_theRegisters.Zf = b == 0;
        m_theRegisters.Hf = false;
        m_theRegisters.Pf = IsEvenParity(b);
        m_theRegisters.Nf = false;
        m_theRegisters.Cf = oldHighBit != 0x00;
        m_theRegisters.SetFlags53From(b);
        return b;
    }
    ...
    /// <summary>
    /// Rotate register right through carry status.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Shift left, overflowing into the carry flag.
    /// </summary>
    /// <remarks>
